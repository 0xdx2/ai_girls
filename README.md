...
# 开发模式（热重载）
cd sarah-tauri & cargo tauri dev -- --manifest-path Cargo.toml

# 生产构建（输出 .app / .dmg）
cd sarah-tauri & cargo tauri build -- --manifest-path Cargo.toml
```
